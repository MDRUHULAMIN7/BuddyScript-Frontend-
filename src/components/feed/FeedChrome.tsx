...
const notifications: NotificationPreview[] = [
  {
    ...
    actor: "Steve Jobs",
    content: "posted a link in your timeline.",
...
const mightLikePeople = [
  { name: "Radovan SkillArena", title: "Founder & CEO at Trophy", image: "/assets/images/Avatar.png" },
];
...
const eventCards = [
  { day: "10", month: "Jul", title: "No more terrorism no more cry", image: "/assets/images/feed_event1.png" },
  { day: "10", month: "Jul", title: "No more terrorism no more cry", image: "/assets/images/feed_event1.png" },
];
...
function TopNavbar({
  ...
  const profileImage = getAssetUrl(currentUser.profilePicture || "/assets/images/profile.png");

  const handleNotificationKeyDown = (event: KeyboardEvent<HTMLSpanElement>) => {
      ...
      <div className="container _custom_container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
            ...
            <li className="nav-item _header_nav_item">
              <a className="nav-link _header_nav_link" aria-current="page" href="#0" onClick={(event) => event.preventDefault()}>
                <FriendsNavIcon />
              </a>
            </li>
            <li className="nav-item _header_nav_item">
                ...
                >
                  <div className="_notifications_content">
                    ...
                    <div className="_notification_box_right">
                      <button type="button" className="_notification_box_right_link buddy-reset-button">
                  ...
                  <div className="_notifications_drop_box">
                    ...
                    <div className="_notifications_all">
                      {notifications.map((item, index) => (
                        <NotificationRow item={item} key={`${item.kind}-${index}`} />
                      ))}
                    </div>
                  </div>
                </div>
          ...
          <div className="_header_nav_profile">
            <div className="_header_nav_profile_image">
              <img src={profileImage} alt={fullName} className="_nav_profile_img" />
            </div>
            ...
            <div
              className={`_nav_profile_dropdown _profile_dropdown${showProfileMenu ? " show" : ""}`}
              onClick={(event) => event.stopPropagation()}
            >
              <div className="_nav_profile_dropdown_info">
                <div className="_nav_profile_dropdown_image">
                  <img src={profileImage} alt={fullName} className="_nav_drop_img" />
                </div>
                <div className="_nav_profile_dropdown_info_txt">
                  <h4 className="_nav_dropdown_title">{fullName}</h4>
                  <a href="#0" className="_nav_drop_profile" onClick={(event) => event.preventDefault()}>
                    View Profile
                  </a>
                </div>
              </div>
              ...
              <ul className="_nav_dropdown_list">
                <li className="_nav_dropdown_list_item">
                  <button type="button" className="_nav_dropdown_link buddy-reset-button">
                ...
                <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                  <div className="_header_mobile_menu_top_inner">
                    ...
                    <div className="_header_mobile_menu_right">
                      <form className="_header_form_grp" onSubmit={(event) => event.preventDefault()}>
                        <a href="#0" className="_header_mobile_search" onClick={(event) => event.preventDefault()}>
                          <SearchIcon />
                        </a>
                      </form>
                    </div>
            ...
            <div className="row">
              <div className="col-xl-12 col-lg-12 col-md-12">
                <ul className="_mobile_navigation_bottom_list">
                  ...
                  <li className="_mobile_navigation_bottom_item">
                    <a href="#0" className="_mobile_navigation_bottom_link" onClick={(event) => event.preventDefault()}>
                      <MobileFriendsIcon />
                    </a>
                  </li>
                  <li className="_mobile_navigation_bottom_item">
                  ...
                  <div className="_header_mobile_toggle">
                    <button type="button" className="_header_mobile_btn_link buddy-reset-button" onClick={onToggleProfile}>
                      <MobileMenuIcon />
                    </button>
                  </div>
                </ul>
...
function NotificationRow({ item }: { item: NotificationPreview }) {
  return (
      ...
      <div className="_notification_txt">
        <p className="_notification_para">
          {item.kind === "post" ? (
            ...
            <>
              An admin changed the name of the group <span className="_notify_txt_link">{item.groupName}</span> to{" "}
              <span className="_notify_txt_link">{item.nextGroupName}</span>
            </>
          )}
        </p>
...
function ExploreLearningIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20">
      <path
        className="buddy-explore-fill"
        fill="#666"
...
function ExploreFindFriendsIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
      <path
        className="buddy-explore-fill"
...
function ExploreGroupIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path className="buddy-explore-stroke" d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />
      <circle className="buddy-explore-stroke" cx="9" cy="7" r="4" />
      <path className="buddy-explore-stroke" d="M23 21v-2a4 4 0 0 0-3-3.87" />
      <path className="buddy-explore-stroke" d="M16 3.13a4 4 0 0 1 0 7.75" />
    </svg>
  );
}

function ExploreGamingIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
      <path
        className="buddy-explore-fill"
...
function ExploreSavePostIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 24" fill="none" stroke="#666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path className="buddy-explore-stroke" d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z" />
      <polyline className="buddy-explore-stroke" points="17 21 17 13 7 13 7 21" />
      <polyline className="buddy-explore-stroke" points="7 3 7 8 15 8" />
    </svg>
  );
}
        ...
        <div className="_left_inner_area_suggest _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          <div className="_left_inner_area_suggest_content _mar_b24">
            ...
            <span className="_left_inner_area_suggest_content_txt">
              <a className="_left_inner_area_suggest_content_txt_link" href="#0" onClick={(event) => event.preventDefault()}>
                See All
              </a>
            </span>
          </div>
      ...
      <div className="_layout_left_sidebar_inner">
        <div className="_left_inner_area_event _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          <div className="_left_inner_event_content">
            ...
            <a href="#0" className="_left_inner_event_link" onClick={(event) => event.preventDefault()}>
              See all
            </a>
          </div>
          {eventCards.map((eventCard, index) => (
            <a
              ...
              href="#0"
              key={`${eventCard.title}-${index}`}
              onClick={(event) => event.preventDefault()}
            >
              <div className="_left_inner_event_card">
                <div className="_left_inner_event_card_iamge">
                  <img src={eventCard.image} alt={eventCard.title} className="_card_img" />
                </div>
                <div className="_left_inner_event_card_content">
                  <div className="_left_inner_card_date">
                    <p className="_left_inner_card_date_para">{eventCard.day}</p>
                    <p className="_left_inner_card_date_para1">{eventCard.month}</p>
                  </div>
                  <div className="_left_inner_card_txt">
                    <h4 className="_left_inner_event_card_title">{eventCard.title}</h4>
                  </div>
                </div>
                <hr className="_underline" />
                <div className="_left_inner_event_bottom">
                  <p className="_left_iner_event_bottom">17 People Going</p>
                  <a href="#0" className="_left_iner_event_bottom_link" onClick={(event) => event.preventDefault()}>
                    Going
                  </a>
                </div>
              </div>
        ...
        <div className="_right_inner_area_info _padd_t24  _padd_b24 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          <div className="_right_inner_area_info_content _mar_b24">
            ...
            <span className="_right_inner_area_info_content_txt">
              <a className="_right_inner_area_info_content_txt_link" href="#0" onClick={(event) => event.preventDefault()}>
                See All
              </a>
            </span>
          </div>
          ...
          <div className="_feed_top_fixed">
            <div className="_feed_right_inner_area_card_content _mar_b24">
              ...
              <span className="_feed_right_inner_area_card_content_txt">
                <a className="_feed_right_inner_area_card_content_txt_link" href="#0" onClick={(event) => event.preventDefault()}>
                  See All
                </a>
              </span>
            </div>
