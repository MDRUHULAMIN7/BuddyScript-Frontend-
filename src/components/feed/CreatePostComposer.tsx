      ...
      <div className="_feed_inner_text_area_box">
        ...
        <div className="form-floating _feed_inner_text_area_box_form ">
          ...
          <label className="_feed_textarea_label" htmlFor="feed-post-textarea">
            Write something ... <ComposerPencilIcon />
          </label>
        </div>
      </div>
