      ...
      >
        <div className="flex flex-wrap items-center gap-2">
          <ComposerActionButton
            icon={<ComposerPhotoIcon className={isDark ? "text-white/58" : "text-black/55"} />}
            label="Photo"
            isDark={isDark}
          ...
          />
          <ComposerActionButton
            icon={<ComposerVideoIcon className={isDark ? "text-white/58" : "text-black/55"} />}
            label="Video"
            isDark={isDark}
          />
          <ComposerActionButton
            icon={<ComposerEventIcon className={isDark ? "text-white/58" : "text-black/55"} />}
            label="Event"
            isDark={isDark}
          />
          <ComposerActionButton
            icon={<ComposerArticleIcon className={isDark ? "text-white/58" : "text-black/55"} />}
            label="Article"
            isDark={isDark}
          />
        </div>
...
function ComposerPencilIcon({ className }: { className?: string }) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="23" height="24" fill="none" viewBox="0 0 23 24">
...
function ComposerPhotoIcon({ className }: { className?: string }) {
  return (
...
function ComposerVideoIcon({ className }: { className?: string }) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
...
function ComposerEventIcon({ className }: { className?: string }) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
...
function ComposerArticleIcon({ className }: { className?: string }) {
  return (
