    ...
    <div className="_comment_main">
      ...
      <div className="_comment_area">
        <div className="_comment_details">
          <div className="_comment_details_top">
            <div className="_comment_name">
              <a href="#0">
                <h4 className="_comment_name_title">{getFullName(comment.author.firstName, comment.author.lastName)}</h4>
              </a>
            </div>
          </div>
          ...
          {comment.reactionCount > 0 ? (
            <div className="_total_reactions">
              <button type="button" className="buddy-reset-button buddy-comment-reactions" onClick={() => setShowLikers(true)}>
            ...
            <div className="_comment_reply_num">
              <ul className="_comment_reply_list">
                <li>
                  <button
                    type="button"
                    className="buddy-reset-button buddy-comment-action-button"
                ...
                <li>
                  <button type="button" className="buddy-reset-button buddy-comment-action-button">
                    <span>Share</span>
                  </button>
                </li>
                <li>
        ...
        {showReplyComposer ? (
          <div className="_feed_inner_comment_box">
            ...
            >
              ...
              <div className="_feed_inner_comment_box_icon">
                <button className="_feed_inner_comment_box_icon_btn" type="submit" aria-label="Post reply">
                  <CommentMicIcon />
                </button>
                <button className="_feed_inner_comment_box_icon_btn" type="button" aria-label="Reply options">
                  <CommentImageIcon />
                </button>
              </div>
            </form>
        ...
        {comment.replyCount > 0 ? (
          <div className="buddy-comment-replies-toggle">
            <button type="button" className="_previous_comment_txt" onClick={() => setShowReplies((value) => !value)}>
